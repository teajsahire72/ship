...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title">List of Accomodations</h3>
...
<script>
	$(document).ready(function(){
		...
		$('#create_new').click(function(){
			uni_modal("<i class='fa fa-plus'></i> Add New Accommodation","maintenance/manage_accommodation.php","mid-large")
		})
		$('.edit_data').click(function(){
			uni_modal("<i class='fa fa-plus'></i> Add New Accommodation","maintenance/manage_accommodation.php?id="+$(this).attr('data-id'),"mid-large")
		})
		$('.table').dataTable();
	})
